...
<div class="box box-default">
	...
	<div class="box-body">
		...
		<?= $form->field($model, 'mb_rekening_kelompok_id')->dropDownList(
             ArrayHelper::map(MbRekeningKelompok::find()->all(),'mb_rekening_kelompok_id','mb_rekening_kelompok_nama'),
            [
                'prompt'=>'---Pilih Kelompok Rekening---',
            ]); ?>
