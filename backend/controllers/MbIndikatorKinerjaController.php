 ...
 */
class MbIndikatorKinerjaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all MbIndikatorKinerja models.
     * @return mixed
     */
    ...
    /**
     * Updates an existing MbIndikatorKinerja model.
    ...
    /**
     * Deletes an existing MbIndikatorKinerja model.
    ...
    /**
     * Finds the MbIndikatorKinerja model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return MbIndikatorKinerja the loaded model
